...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        patients, created = orm.Group.objects.get_or_create(name='Subjects')
        patients.name = 'Patients'
        patients.is_editable = False
        patients.save()
    ...
    def backwards(self, orm):
        ...
        patients, created = orm.Group.objects.get_or_create(name='Patients')
        patients.name = 'Subjects'
        patients.is_editable = False
        patients.save()
