...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field group_contacts on 'Group'
        m2m_table_name = db.shorten_name(u'groups_group_group_contacts')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('group', models.ForeignKey(orm[u'groups.group'], null=False)),
            ('groupcontact', models.ForeignKey(orm[u'groups.groupcontact'], null=False))
        ))
        db.create_unique(m2m_table_name, ['group_id', 'groupcontact_id'])


    def backwards(self, orm):
        # Removing M2M table for field group_contacts on 'Group'
        db.delete_table(db.shorten_name(u'groups_group_group_contacts'))
