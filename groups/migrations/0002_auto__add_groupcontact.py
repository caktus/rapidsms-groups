...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'GroupContact'
        db.create_table(u'groups_groupcontact', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('contact', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['rapidsms.Contact'], unique=True)),
        ...
        db.send_create_signal(u'groups', ['GroupContact'])


    def backwards(self, orm):
        # Deleting model 'GroupContact'
        db.delete_table(u'groups_groupcontact')


    models = {
        u'groups.group': {
            'Meta': {'object_name': 'Group'},
            'contacts': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'groups'", 'blank': 'True', 'to': u"orm['groups.GroupContact']"}),
